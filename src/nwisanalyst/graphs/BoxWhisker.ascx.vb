...
Public MustInherit Class GraphsBoxWhisker
...
#End Region
    ...
    Public Sub Plot(ByRef objDataTable As DataTable, ByVal strStationName As String, ByVal strVariableName As String, ByRef objOptions As OptionsPlotOptions)
        mobjDataTable = objDataTable
        mstrStationName = strStationName
        mstrVariableName = strVariableName
        mobjOptions = objOptions
        PesgoWeb.AlternateText = "Box Whisker of " & strVariableName & " at " & strStationName
        PesgoWeb.ImageUrl = "graphs/BoxWhiskerGraph.aspx?" & Now.Ticks.ToString
    End Sub
