...
Public Class GraphsProbability
...
#End Region
    ...
    Public Sub Plot(ByRef objDataTable As DataTable, ByVal strStationName As String, ByVal strVariableName As String, ByRef objOptions As nwisanalyst.OptionsPlotOptions)
        ...
        PesgoWeb.AlternateText = "Probability of " & strVariableName & " at " & strStationName
        PesgoWeb.ImageUrl = "graphs/ProbabilityGraph.aspx?" & Now.Ticks.ToString
    End Sub
